...
export class AudioBus {
  constructor(
    ...
    const newRefDistance = (pannerNode.refDistance / pannerNode.maxDistance) * newMaxDistance;
    const newRolloffFactor = (pannerNode.rolloffFactor / pannerNode.maxDistance) * newMaxDistance;
